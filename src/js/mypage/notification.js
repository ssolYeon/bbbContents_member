...
const notificationController = (() => {
    ...
    const bindNotificationModals = () => {
        const gnbContainer = documentq.querySelector('gnb_container');
        const list = document.querySelector('.notification_list_container .list_contents');
        if (!list) return;
        ...
        list.addEventListener('click', (e) => {
            ...
            if (openBtn) {
                ...
                gnbContainer.classList.add('hidden');
            ...
            if (cancelBtn) {
                e.preventDefault();
                e.stopPropagation();
                gnbContainer.classList.remove('hidden');
